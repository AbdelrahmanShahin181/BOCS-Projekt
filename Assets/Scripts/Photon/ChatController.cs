...
namespace Photon.Chat.Demo
{
    ...
    public class ChatController : MonoBehaviour, IChatClientListener
    {
        ...
        public async void Start()
        {
            ...
            #endif
            Debug.Log("Check existing of  ChatAppSettings");
            Debug.Log("ChatAppSettings: " + this.chatAppSettings);
        ...
        public void Connect()
        {
            ...
            Debug.Log("chatClient: " + this.chatClient);
            Debug.Log("Connecting to: " + this.chatAppSettings.AppIdChat);
            #if !UNITY_WEBGL
        ...
        public void OnClickSend()
        {
            ...
            Debug.Log("InputFieldChat.text: " + InputFieldChat.text);
        ...
        {
            Debug.Log($"SendChatMessage: {inputLine}");

            Debug.Log("chatClient: " + this.chatClient);
            this.selectedChannelName = this.ChannelsToJoinOnConnect[0];
            ...
            bool doingPrivateChat =false;// this.chatClient.PrivateChannels.ContainsKey(this.selectedChannelName); //debugging
            ...
            else
            {
                ...
                {
                    this.chatClient.PublishMessage(this.selectedChannelName, inputLine); //this.selectedChannelName //inputLine //debugging
                }
            }*/
        ...
        {
            Debug.Log($"Abdo Connected to server {this.chatClient.AppVersion}");
